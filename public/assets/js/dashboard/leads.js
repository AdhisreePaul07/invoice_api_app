const dealsStageConfig = {
	...
	colors: ['var(--app-primary)', 'rgba(var(--app-primary-rgb),0.1)'],
	dataLabels: {
		enabled: true,
		offsetY: -5,
		style: {
...
const leadSourceChartConfig = {
	...
	colors: [
		...
		'rgba(var(--app-primary-rgb), 0.7)',
		'rgba(var(--app-primary-rgb), 0.5)',
...
const ConversionFunnelConfig = {
	...
	colors: [
		'rgba(var(--app-primary-rgb), 1)',
		'rgba(var(--app-primary-rgb), 0.82)',
		'rgba(var(--app-primary-rgb), 0.64)',
		'rgba(var(--app-primary-rgb), 0.46)',
